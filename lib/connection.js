...
// @ts-ignore
const { useSingleFileAuthState, DisconnectReason, default: makeWASocket } = (await import('@adiwajshing/baileys')).default

const authFile = `${Helper.opts._[0] || 'haruno'}.store.json`
